        ...
        <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex">
                            <div class="col">
                            <p class="text-primary m-0 fw-bold float-left">Brands Info</p>
                            </div>
                            <div class="col" style="flex: revert;">
                            <a href="?do=Add" class="btn btn-primary btn-sm">Add Brand</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php foreach ($rows as $row) {
                                                ...
                                                echo "<td><a href = \"?do=Edit&id={$row['Brand_ID']}\" class='btn btn-primary btn-sm cust'>Edit</a> <a href = \"?do=Delete&id={$row['Brand_ID']}\" class='btn btn-primary btn-sm'>Delete</a></td>";
