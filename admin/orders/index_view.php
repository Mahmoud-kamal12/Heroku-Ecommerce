                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php foreach ($rows as $row) {
                                                ...
                                                echo"<tr>";
                                                echo "<td style='font-weight: 900;'>{$row['Order_ID']}</td>";

                                                echo "<td>{$name}</td>";
                                                echo "<td>{$row['Order_Date']}</td>";
                                                echo "<td>{$row['Order_User_Email']}</td>";
                                                echo "<td>{$row['Order_User_Phone']}</td>";
                                                echo "<td>{$row['Order_Total']}</td>";
                                                echo "<td>{$row['Order_Status']}</td>";


                                                echo "<td><a href = \"?do=Show&order_id={$row['Order_ID']}&user_id={$row['Order_User_id']}\" class='btn btn-primary btn-sm cust'><i class='fas fa-tasks'> Show Info</i></a></td>";
