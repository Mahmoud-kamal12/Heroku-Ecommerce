...
define('PAYPAL_RETURN_URL', 'https://ecommercemahmoud.herokuapp.com/controllers/PayPal/success.php');
define('PAYPAL_CANCEL_URL', 'https://ecommercemahmoud.herokuapp.com/E-Commerce/controllers/PayPal/cancel.php');
